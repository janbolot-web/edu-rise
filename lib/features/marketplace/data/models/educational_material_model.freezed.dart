...
/// @nodoc
abstract mixin class $EducationalMaterialModelCopyWith<$Res>  {
  factory $EducationalMaterialModelCopyWith(EducationalMaterialModel value, $Res Function(EducationalMaterialModel) _then) = _$EducationalMaterialModelCopyWithImpl;
@useResult
$Res call({
 String id, String title, String description, String authorId, String authorName, String authorAvatar, String type, String subject, String grade, double price, String currency, String thumbnailUrl, List<String> fileUrls, int downloads, double rating, int reviewCount, String createdAt, String updatedAt, bool isPublished, List<String> tags, String language, int fileSize, String fileFormat, String difficulty, int estimatedTime, String previewText, List<String> learningObjectives, bool isFree, bool isFeatured, int viewCount, String moderationStatus, String? moderationComment, String? moderatedBy, String? moderatedAt
});
...
/// @nodoc
class _$EducationalMaterialModelCopyWithImpl<$Res>
    implements $EducationalMaterialModelCopyWith<$Res> {
  _$EducationalMaterialModelCopyWithImpl(this._self, this._then);

  final EducationalMaterialModel _self;
  final $Res Function(EducationalMaterialModel) _then;
...
/// Adds pattern-matching-related methods to [EducationalMaterialModel].
extension EducationalMaterialModelPatterns on EducationalMaterialModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EducationalMaterialModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EducationalMaterialModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EducationalMaterialModel value)  $default,){
final _that = this;
switch (_that) {
case _EducationalMaterialModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EducationalMaterialModel value)?  $default,){
final _that = this;
switch (_that) {
case _EducationalMaterialModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String description,  String authorId,  String authorName,  String authorAvatar,  String type,  String subject,  String grade,  double price,  String currency,  String thumbnailUrl,  List<String> fileUrls,  int downloads,  double rating,  int reviewCount,  String createdAt,  String updatedAt,  bool isPublished,  List<String> tags,  String language,  int fileSize,  String fileFormat,  String difficulty,  int estimatedTime,  String previewText,  List<String> learningObjectives,  bool isFree,  bool isFeatured,  int viewCount,  String moderationStatus,  String? moderationComment,  String? moderatedBy,  String? moderatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EducationalMaterialModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String description,  String authorId,  String authorName,  String authorAvatar,  String type,  String subject,  String grade,  double price,  String currency,  String thumbnailUrl,  List<String> fileUrls,  int downloads,  double rating,  int reviewCount,  String createdAt,  String updatedAt,  bool isPublished,  List<String> tags,  String language,  int fileSize,  String fileFormat,  String difficulty,  int estimatedTime,  String previewText,  List<String> learningObjectives,  bool isFree,  bool isFeatured,  int viewCount,  String moderationStatus,  String? moderationComment,  String? moderatedBy,  String? moderatedAt)  $default,) {final _that = this;
switch (_that) {
case _EducationalMaterialModel():
return $default(_that.id,_that.title,_that.description,_that.authorId,_that.authorName,_that.authorAvatar,_that.type,_that.subject,_that.grade,_that.price,_that.currency,_that.thumbnailUrl,_that.fileUrls,_that.downloads,_that.rating,_that.reviewCount,_that.createdAt,_that.updatedAt,_that.isPublished,_that.tags,_that.language,_that.fileSize,_that.fileFormat,_that.difficulty,_that.estimatedTime,_that.previewText,_that.learningObjectives,_that.isFree,_that.isFeatured,_that.viewCount,_that.moderationStatus,_that.moderationComment,_that.moderatedBy,_that.moderatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String description,  String authorId,  String authorName,  String authorAvatar,  String type,  String subject,  String grade,  double price,  String currency,  String thumbnailUrl,  List<String> fileUrls,  int downloads,  double rating,  int reviewCount,  String createdAt,  String updatedAt,  bool isPublished,  List<String> tags,  String language,  int fileSize,  String fileFormat,  String difficulty,  int estimatedTime,  String previewText,  List<String> learningObjectives,  bool isFree,  bool isFeatured,  int viewCount,  String moderationStatus,  String? moderationComment,  String? moderatedBy,  String? moderatedAt)?  $default,) {final _that = this;
switch (_that) {
case _EducationalMaterialModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.authorId,_that.authorName,_that.authorAvatar,_that.type,_that.subject,_that.grade,_that.price,_that.currency,_that.thumbnailUrl,_that.fileUrls,_that.downloads,_that.rating,_that.reviewCount,_that.createdAt,_that.updatedAt,_that.isPublished,_that.tags,_that.language,_that.fileSize,_that.fileFormat,_that.difficulty,_that.estimatedTime,_that.previewText,_that.learningObjectives,_that.isFree,_that.isFeatured,_that.viewCount,_that.moderationStatus,_that.moderationComment,_that.moderatedBy,_that.moderatedAt);case _:
  return null;
...
/// @nodoc
abstract mixin class _$EducationalMaterialModelCopyWith<$Res> implements $EducationalMaterialModelCopyWith<$Res> {
  factory _$EducationalMaterialModelCopyWith(_EducationalMaterialModel value, $Res Function(_EducationalMaterialModel) _then) = __$EducationalMaterialModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String title, String description, String authorId, String authorName, String authorAvatar, String type, String subject, String grade, double price, String currency, String thumbnailUrl, List<String> fileUrls, int downloads, double rating, int reviewCount, String createdAt, String updatedAt, bool isPublished, List<String> tags, String language, int fileSize, String fileFormat, String difficulty, int estimatedTime, String previewText, List<String> learningObjectives, bool isFree, bool isFeatured, int viewCount, String moderationStatus, String? moderationComment, String? moderatedBy, String? moderatedAt
});
...
/// @nodoc
class __$EducationalMaterialModelCopyWithImpl<$Res>
    implements _$EducationalMaterialModelCopyWith<$Res> {
  __$EducationalMaterialModelCopyWithImpl(this._self, this._then);

  final _EducationalMaterialModel _self;
  final $Res Function(_EducationalMaterialModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? authorId = null,Object? authorName = null,Object? authorAvatar = null,Object? type = null,Object? subject = null,Object? grade = null,Object? price = null,Object? currency = null,Object? thumbnailUrl = null,Object? fileUrls = null,Object? downloads = null,Object? rating = null,Object? reviewCount = null,Object? createdAt = null,Object? updatedAt = null,Object? isPublished = null,Object? tags = null,Object? language = null,Object? fileSize = null,Object? fileFormat = null,Object? difficulty = null,Object? estimatedTime = null,Object? previewText = null,Object? learningObjectives = null,Object? isFree = null,Object? isFeatured = null,Object? viewCount = null,Object? moderationStatus = null,Object? moderationComment = freezed,Object? moderatedBy = freezed,Object? moderatedAt = freezed,}) {
  return _then(_EducationalMaterialModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String,authorId: null == authorId ? _self.authorId : authorId // ignore: cast_nullable_to_non_nullable
